...
module('Unit | Service | day4/passport-processing', function(hooks) {
  ...
  test('it solves the example provided from aoc for part 1', function (assert) {
    const result = service.countValidPassports(exampleData, false);
  ...
  test('it solves the 1st example provided from aoc for part 2', function (assert) {
    const result = service.countValidPassports(exampleDataPart2a, true);
    assert.equal(result, 0);
  });

  test('it solves the 2nd example provided from aoc for part 2', function (assert) {
    const result = service.countValidPassports(exampleDataPart2b, true);
  ...
  const exampleDataPart2a: Array<string> = (`
  eyr:1972 cid:100
  ...
  const exampleDataPart2b: Array<string> = (`
