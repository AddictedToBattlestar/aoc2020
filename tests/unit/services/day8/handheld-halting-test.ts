...
module('Unit | Service | day8/handheld-halting', function(hooks) {
  setupTest(hooks);
  let service: any;

  hooks.beforeEach(function () {
    service = this.owner.lookup('service:day8/handheld-halting');
  });

  test('it solves the example provided from aoc for part 1', function (assert) {
    const result = service.getAccumulatorValuePriorToRepetition(exampleData);
  ...
  test('it solves the example provided from aoc for part 2', function (assert) {
    const result = service.fixBadInstructionAndGetAccumulatorValue(exampleData);
