...
module('Unit | Service | day2-password-philosophy', function (hooks) {
  setupTest(hooks);
  let service: any;
  ...
  test('it solves for part 1', function (assert) {
    ...
    console.info(`-Day 2- The answer to part 1 is: ${result}\n`);
    assert.ok(result);
  });
  ...
  test('it solves for part 2', function (assert) {
    ...
    console.info(`-Day 2- The answer to part 2 is: ${result}\n`);
    assert.ok(result);
  });
